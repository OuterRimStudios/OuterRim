...
public class Controls : PlayerActionSet
{
    ...
    public Controls()
    {
        ...
        Fire2 = CreatePlayerAction("Fire2");
    ...
    public static Controls CreateWithDefaultBindings()
    {
        ...
        controls.Fire2.AddDefaultBinding(InputControlType.LeftTrigger);
        controls.Fire2.AddDefaultBinding(Mouse.RightButton);

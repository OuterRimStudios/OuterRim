...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    {
        [SerializeField] private float m_MaxEnginePower = 150f;        // The maximum output of the engine.
        [SerializeField] private float m_Lift = 100;               // The amount of lift generated by the aeroplane moving forwards.
        [SerializeField] private float m_ZeroLiftSpeed = 0;         // The speed at which lift is no longer applied.
        ...
        [SerializeField] private float m_YawEffect = 50f;            // The strength of effect for yaw input.
        [SerializeField] private float m_BankedTurnEffect = 5f;     // The amount of turn from doing a banked turn.
        [SerializeField] private float m_AerodynamicEffect = 0.01f;   // How much aerodynamics affect the speed of the aeroplane.
        [SerializeField] private float m_AutoTurnPitch = 90f;        // How much the aeroplane automatically pitches when in a banked turn.
        ...
        [SerializeField] private float m_ThrottleChangeSpeed = 10f;  // The speed with which the throttle changes.
